...
from PIL import ImageTk, Image                              # Image and Python File must be in the same Directory/Folder
import calendar
...
img = ImageTk.PhotoImage(Image.open('calendar.png'))        # Download Image from Telegram Channel
label = Label(image=img)                                    # t.me/coderbuzz
